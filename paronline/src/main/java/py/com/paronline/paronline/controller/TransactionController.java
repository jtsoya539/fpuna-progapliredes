 ...
 */
package py.com.paronline.paronline.controller;
...
import py.com.paronline.paronline.service.TransactionService;
...
public class TransactionController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id != null) {
            ...
            rd = request.getRequestDispatcher("/view/transaction/details.jsp");
        } else {
            ArrayList<Transaction> transactions = transactionService.getTransactions();
            request.setAttribute("transactions", transactions);

            rd = request.getRequestDispatcher("/view/transaction/index.jsp");
        }
